        ...
        <div className="contact_wrapper">
            ...
            <div className="contact">
                <div className="contact__text">
                    ...
                    <p>Puedes enviarme un email a <a href="mailto:hello@federicotllorente.work">hello@federicotllorente.work</a>, o simplemente completa este formulario. Y si quieres, puedes también contactarme por mis redes sociales:</p>
                    <ul>
