...
function BurgerMenu() {
    ...
    if (!showingMenu) {
        return (
            <React.Fragment>
                <div className="burger_menu_btn" id="burger_menu_btn" onClick={e => handleOpenMenu()}>
                ...
                <Link className="download_resume_btn" to="/" id="download_resume_btn">Download my Resume/CV</Link>
            </React.Fragment>
        );
    }
    return (
        <React.Fragment>
            <div className="burger_menu" id="burger_menu">
                ...
                <div className="burger_menu__close_btn" id="burger_menu__close_btn" onClick={e => handleCloseMenu()}>
